...
% Tabelle aus TEX-Datei einfügen: caption, label, file
\newcommand{\tabelle}[3]{%
    \begin{table}[H]
    \centering
    \singlespacing
...
% Tabelle aus TEX-Datei im Anhang einfügen: caption, file
...
% Graph einfügen: caption, label, file
\newcommand{\graph}[3]{%
        \begin{figure}[H]
            \centering
            \input{src/#3}
...
% Screenshot einfügen: caption, label, file, title
...
% Schaltkreis einfügen: caption, label, file
\newcommand{\circuit}[3]{%
        \begin{figure}[H]
            \centering
            \adjustbox{max width=\linewidth}{
